...
lateinit var app: AvbToolkitApplication

class AvbToolkitApplication : Application(), ViewModelStoreOwner {
                ...
                .addInterceptor { block ->
                    block.proceed(
                        block.request().newBuilder()
                            .header("User-Agent", "AVBToolkit/${BuildConfig.VERSION_CODE}")
